...
###### Summary of IPv6 Address types and the Commands that create them
...
Link local     [fe80::/10]      ```ipv6 address address link-local```
                                ```Autogenerated by all ipv6 address cmds```
                                ```Autogenerated by all ipv6 enable cmds``` 

Hosts multicast[ff02::1]        ```Autogenerated by all ipv6 address cmds```

All Router mc  [ff02::2]        ```Autogenerated by all ipv6 address cmds```

Routing Prot mc[Various]        ```Added when protocol is enabled on the int```

Solicited-node [ff02::1ff/104]  ```Autogenerated by all ipv6 address cmds```
